...
export default function Create({ companies }) {
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="text-2xl font-bold text-gray-800 dark:text-white">Crear Usuario</h2>}
        >
            ...
            <div className="max-w-2xl mx-auto">
                <div className="bg-white dark:bg-[#1e293b] rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700/50 overflow-hidden transition-colors duration-300">
                    <div className="p-6 border-b border-gray-100 dark:border-slate-700/50 bg-gray-50/50 dark:bg-transparent">
                        <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Información del Nuevo Usuario</h3>
                        <p className="text-sm text-gray-500 dark:text-slate-400">Completa los datos para registrar un nuevo integrante.</p>
                    </div>
                    ...
                    <form onSubmit={submit} className="p-8 space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <InputLabel htmlFor="password" value="Contraseña" className="dark:text-slate-300" />
                                <TextInput
                                    id="password"
                                    type="password"
                                    name="password"
                            ...
                            <div>
                                <InputLabel htmlFor="password_confirmation" value="Confirmar Contraseña" className="dark:text-slate-300" />
                                <TextInput
