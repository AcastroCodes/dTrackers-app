...
export default function Edit({ company }) {
    ...
    const hasLocation = data.latitude !== '' && data.latitude !== null && data.latitude !== undefined;

    return (
        <AuthenticatedLayout
            header={<h2 className="text-2xl font-bold text-gray-800 dark:text-white">Editar Empresa</h2>}
        >
            ...
            <MapPickerModal
                ...
                initialLat={hasLocation ? data.latitude : null}
                initialLng={hasLocation ? data.longitude : null}
            />
            ...
            <div className="max-w-2xl mx-auto">
                <div className="bg-white dark:bg-[#1e293b] rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700/50 overflow-hidden transition-colors duration-300">
                    <div className="px-5 py-3 border-b border-gray-100 dark:border-slate-700/50 bg-gray-50/50 dark:bg-transparent">
                        <h3 className="text-sm font-semibold text-gray-800 dark:text-white">Actualizar Organización</h3>
                        <p className="text-xs text-gray-500 dark:text-slate-400">Modifica los datos de la empresa seleccionada.</p>
                    </div>

                    <form onSubmit={submit} className="p-5 space-y-4">
                        {/* Nombre */}
                        <div>
                            <InputLabel htmlFor="name" value="Nombre de la Empresa" className="dark:text-slate-300" />
                            <TextInput
                                id="name"
                                name="name"
                                value={data.name}
                        ...
                        {/* RUC / NIT */}
                        <div>
                            <InputLabel htmlFor="tax_id" value="RUC / NIT (ID Fiscal)" className="dark:text-slate-300" />
                            <TextInput
                                id="tax_id"
                                name="tax_id"
                                value={data.tax_id}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                            ...
                            <div className="md:col-span-2">
                                <InputLabel htmlFor="phone" value="Teléfono" className="dark:text-slate-300 text-xs" />
                                <TextInput
                                    id="phone"
                                    name="phone"
                                    value={data.phone}
                        ...
                        <div className="rounded-xl border border-gray-100 dark:border-slate-700/50 overflow-hidden">
                            <div className="px-4 py-2.5 bg-gray-50/80 dark:bg-slate-800/40 flex items-center justify-between">
                                <div className="flex items-center gap-1.5">
                                    ...
                                    <span className="text-xs text-gray-400 dark:text-slate-500">(partida/llegada de rutas)</span>
                                </div>
                                <button
                                    type="button"
                                ...
                                {hasLocation ? (
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p className="text-xs font-medium text-gray-700 dark:text-slate-300">Ubicación guardada</p>
                                    ...
                                    <p className="text-xs text-gray-400 dark:text-slate-500 italic">
                                        Sin ubicación establecida — haz clic en "Abrir mapa" para seleccionarla.
                                    </p>
                                )}
                            </div>
                        </div>
