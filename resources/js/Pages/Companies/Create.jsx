...
export default function Create() {
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="text-2xl font-bold text-gray-800 dark:text-white">Nueva Empresa</h2>}
        >
            ...
            <div className="max-w-2xl mx-auto">
                <div className="bg-white dark:bg-[#1e293b] rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700/50 overflow-hidden transition-colors duration-300">
                    <div className="px-5 py-3 border-b border-gray-100 dark:border-slate-700/50 bg-gray-50/50 dark:bg-transparent">
                        <h3 className="text-sm font-semibold text-gray-800 dark:text-white">Información de la Organización</h3>
                        <p className="text-xs text-gray-500 dark:text-slate-400">Registra la empresa. Los usuarios se asocian desde su perfil.</p>
                    </div>
