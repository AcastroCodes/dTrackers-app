...
export default function Create({ companies, clients, trucks, drivers, isSuperAdmin, defaultCompanyId }) {
    ...
    return (
        <AuthenticatedLayout header={<h2 className="text-2xl font-bold text-gray-800 dark:text-white">Planificar Ruta</h2>}>
